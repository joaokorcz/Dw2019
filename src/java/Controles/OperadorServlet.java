...
public class OperadorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = daoOperador.autoIdOperador();
        ...
        operador.setTelefone(tel);
        
        daoOperador.inserir(operador);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("cdOperador.jsp").forward(request, response);
