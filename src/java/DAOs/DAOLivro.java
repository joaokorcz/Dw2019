...
public class DAOLivro extends DAOGenerico<Livro> {
    ...
    public List<Livro> listInOrderId_nome(String nome) {
        return em.createQuery("SELECT e FROM Livro e WHERE e.nomeLivro LIKE \"%" + nome + "%\" ORDER BY e.idLivro").getResultList();
    } 
