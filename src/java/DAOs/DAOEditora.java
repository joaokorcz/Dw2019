...
public class DAOEditora extends DAOGenerico<Editora> {
    ...
    public List<Editora> listInOrderId_nome(String nome) {
        return em.createQuery("SELECT e FROM Editora e WHERE e.nomeEditora LIKE \"%" + nome + "%\" ORDER BY e.idEditora").getResultList();
    } 
