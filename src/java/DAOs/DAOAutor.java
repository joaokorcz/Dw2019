...
public class DAOAutor extends DAOGenerico<Autor> {
    ...
    public List<Autor> listInOrderId_nome(String nome) {
        return em.createQuery("SELECT e FROM Autor e WHERE e.nomeAutor LIKE \"%" + nome + "%\" ORDER BY e.idAutor").getResultList();
    } 
