...
<html lang="pt-br">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="img/livros/livro.png" />
    ...
    <body>
        <div class="container-scroller">
            ...
            <% String nome = request.getAttribute("UsuarioNome").toString(); %>
            <% Object usu = request.getAttribute("Usuario");%>
                            ...
                            <div class="nav-link">
                                <div class="user-wrapper">
                                    ...
                                    <div class="text-wrapper">
                                        <p class="profile-name"><% out.print(nome); %></p>
                                        <div>
                                    ...
                                    <div class="card-body">
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <p class="mb-0 text-right">Totais alugados</p>
                                        ...
                                        <p class="text-muted mt-3 mb-0">
                                            <i class="mdi mdi-alert-octagon mr-1" aria-hidden="true"></i> Índice Baixíssimo
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card card-statistics">
                                    <div class="card-body">
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <p class="mb-0 text-right">Livros Emprestados</p>
                                                <div class="fluid-container">
                                                    <h3 class="font-weight-medium text-right mb-0">0</h3>
                                                </div>
                                            </div>
                                        ...
                                        <p class="text-muted mt-3 mb-0">
                                            <i class="mdi mdi-bookmark-outline mr-1" aria-hidden="true"></i> Atenção à devolução
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card card-statistics">
                                    <div class="card-body">
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <p class="mb-0 text-right">Históricos Disponíveis</p>
                                                <div class="fluid-container">
                                                    <h3 class="font-weight-medium text-right mb-0">0</h3>
                                                </div>
                                            </div>
                                        ...
                                        <p class="text-muted mt-3 mb-0">
                                            <i class="mdi mdi-calendar mr-1" aria-hidden="true"></i> Dados Estatísticos
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card card-statistics">
                                    <div class="card-body">
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <p class="mb-0 text-right">Multas</p>
                                                <div class="fluid-container">
                                                    <h3 class="font-weight-medium text-right mb-0">0</h3>
                                                </div>
                                            </div>
                                        ...
                                        <p class="text-muted mt-3 mb-0">
                                            <i class="mdi mdi-reload mr-1" aria-hidden="true"></i> Prazos estourados
                                        </p>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="progress">
                                                                <div class="progress-bar bg-warning progress-bar-striped" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0"
                                                                     aria-valuemax="100"></div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="progress">
                                                                <div class="progress-bar bg-danger progress-bar-striped" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0"
                                                                     aria-valuemax="100"></div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="progress">
                                                                <div class="progress-bar bg-success progress-bar-striped" role="progressbar" style="width: 35%" aria-valuenow="35" aria-valuemin="0"
                                                                     aria-valuemax="100"></div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="progress">
                                                                <div class="progress-bar bg-success progress-bar-striped" role="progressbar" style="width: 20%" aria-valuenow="25" aria-valuemin="0"
                                                                     aria-valuemax="100"></div>
                                                            </div>
                                                        </td>
                                                        <td>
