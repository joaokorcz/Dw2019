...
<%
    ...
    MyDateTimeFormat mdt = new MyDateTimeFormat();
    
    Date dev = new Date();
    String hoje = mdt.getDateParaStringBr(dev);
                            ...
                            <div class="col-md-10 d-flex align-items-stretch grid-margin">
                                <div class="row flex-grow">
                                    <div class="col-10">
                                        <div class="card">
                                            <div class="card-body">
                                                <form name="formCd" action="LivroServlet" method="post">
                                                    <div class="row">

                                                        <div class="col-md-10">
                                                            <h4 class="card-title">Novo livro</h4>
                                                        </div>

                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <image src="img/livros/livro.png" style="width: 150px; border-radius: 50%"/>
                                                            <div class="form-group">
                                                                <br>
                                                                <label>Quantidade</label>
                                                                <input style="font-size: 17px;" type="text" class="form-control" name="qt" id="qt">
                                                                <br>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Título</label>
                                                                <input style="font-size: 17px;" type="text" class="form-control" id="titulo" name="titulo">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Autor</label>
                                                                <select style="font-size: 17px;" type="text" class="form-control" id="autor" name="autor">
                                                                    <%
                                                                        for (Autor a : autores) {
                                                                    %>
                                                                    <option value="<%=a.getAutor()%>"><%=a.getAutor()%></option>>
                                                                    <%}%>   
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Local</label>
                                                                <select style="font-size: 17px;"type="text" class="form-control" id="local" name="local">
                                                                    <%
                                                                        for (Local l : locais) {
                                                                    %>
                                                                    <option value="<%=l.getLocal()%>"><%=l.getLocal()%></option>>
                                                                    <%}%>   
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Gênero</label>
                                                                <select style="font-size: 17px;" type="text" class="form-control" id="gen" name="gen">
                                                                    <%
                                                            ...
                                                            <div class="form-group">
                                                                <label>Editora</label>
                                                                <select style="font-size: 17px;" type="text" class="form-control" id="edit" name="edit">
                                                                    <%
                                                                        for (Editora e : editoras) {
                                                                    %>
                                                                    <option value="<%=e.getEditora()%>"><%=e.getEditora()%></option>>
                                                                    <%}%>   
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Data do Cadastro</label>
                                                                <input style="font-size: 17px;" type="text" class="form-control" id="dt" name="dt" value="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
