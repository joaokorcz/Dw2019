                    ...
                    <div class="content-wrapper">
                        <div class="row">                            
                            <div class="col-lg-8 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Prazos estourados</h4>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>05/04/2019</td>
                                                        <td>19/04/2019</td>
                                                        <td><label class="badge badge-danger">14 dias</label></td>
                                                        <td><label class="badge badge-warning">R$ 7,00</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="badge badge-info">Conexão com a Matemática</label></td>
                                                        <td>10/04/2019</td>
                                                        <td>24/04/2019</td>
                                                        <td><label class="badge badge-danger">19 dias</label></td>
                                                        <td><label class="badge badge-warning">R$ 9,50</label></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
