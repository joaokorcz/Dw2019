                            ...
                            <div class="col-md-8 d-flex align-items-stretch grid-margin">
                                <div class="row flex-grow">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Procurar Obra</h4>
                                                <form action="${pageContext.request.contextPath}/BuscarServlet" method="post">
                                                    <div class="form-group">
                                                        <input style="font-size: 17px;" name="nL" type="text" class="form-control" id="sc_nomeLivro" placeholder="Nome do Livro" size="70"
                                                               style="height: 40px; border-radius: 5px;">
                                                    </div> 
                                                    <button type="submit" class="btn btn-inverse-primary btn-fw">Buscar</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="checkbox" class="form-check-input"> Romance
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="checkbox" class="form-check-input"> Infantil
                                                                        <i class="input-helper"></i></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="checkbox" class="form-check-input"> Didático
                                                                        <i class="input-helper"></i></label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="checkbox" class="form-check-input"> Ficção
                                                                        <i class="input-helper"></i></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="col-md-4 d-flex align-items-stretch grid-margin">
                                    <div class="row flex-grow">
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <p style="padding-top: 8px; font-size: 20px; text-align: center;">${livro.nomeLivro}</p>
                                                    <button onClick="alert('Livro reservado!');" type="button" style="margin: auto; display: flex;" class="btn btn-success btn-fw">Reservar Livro</button>                                       
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <button onClick="ra = prompt('Informe seu RA'); dt = prompt('Informe a data em que irá buscar o livro'); alert('Livro: Harry Potter; Ra:' + ra + '; Registro salvo!'); alert('Livro Reservado! Buscar na data: ' + dt)" type="button" style="margin: auto; display: flex;" class="btn btn-success btn-fw">Reservar Livro</button>                                                
                                                <img src="img/livros/1.png" style="padding-top: 8px; margin: auto; display: flex;"/>
