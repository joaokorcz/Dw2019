                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label>RA</label>
                                                            <input style="font-size: 17px;" readonly="true" type="text" class="form-control" id="ra" value="1817833">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <image src="img/faces/joao.jpeg" style="width: 150px; border-radius: 50%"/>
                                                        <div class="form-group">
                                                            <br>
                                                            <label>RG</label>
                                                            <input style="font-size: 17px;" readonly="true" type="text" class="form-control" id="rg" value="10.346.613-0">
                                                            <br>
                                                             <button type="submit" class="btn btn-inverse-info btn-fw">Alterar Informações</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Nome</label>
                                                            <input style="font-size: 17px;" readonly="true" type="text" class="form-control" id="name" value="João Otavio Martini Korczovei">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Data de Nascimento</label>
                                                            <input style="font-size: 17px;" readonly="true" type="text" class="form-control" id="nasc" value="25/03/2001">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Endereço</label>
                                                            <input style="font-size: 17px;" readonly="true" type="text" class="form-control" id="end" value="Avenida Manoel Francisco da Silva, 1102">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>Email</label>
                                                            <input style="font-size: 17px;" readonly="true" type="email" class="form-control" id="email" value="joaokorcz@hotmail.com">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>CPF</label>
                                                            <input style="font-size: 17px;" readonly="true" type="text" class="form-control" id="cpf" value="046.299.399-05">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>CEP</label>
                                                            <input style="font-size: 17px;" readonly="true" type="text" class="form-control" id="cep" value="87340-000">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
