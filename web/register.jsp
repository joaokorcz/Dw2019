<%-- 
    Document   : register
    Created on : 06/05/2019, 15:38:27
    Author     : João Otavio
--%>
                        ...
                        <div class="col-lg-4 mx-auto">
                            ...
                            <div class="auto-form-wrapper">
                                <form action="${pageContext.request.contextPath}/usuario" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Data de Nascimento" name="data" >
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                    <i class="mdi mdi-check-circle-outline"></i>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Endereço" name="end">
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                    <i class="mdi mdi-check-circle-outline"></i>
                                                </span>
                                    ...
                                    <div class="form-group d-flex justify-content-center">
                                        <div class="form-check form-check-flat mt-0">
                                            <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input" checked> Eu aceito os termos
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
