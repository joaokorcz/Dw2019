                            ...
                            <div class="col-md-10 d-flex align-items-stretch grid-margin">
                                <div class="row flex-grow">
                                    <div class="col-10">
                                        <div class="card">
                                            <div class="card-body">
                                                <form name="formCd" action="OperadorServlet" method="post">
                                                    <div class="row">

                                                        <div class="col-md-10">
                                                            <h4 class="card-title">Novo operador</h4>
                                                        </div>

                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <image src="img/operador.png" style="width: 150px; border-radius: 50%"/>
                                                            <div class="form-group">
                                                                <br>
                                                                <label>Senha</label>
                                                                <input style="font-size: 17px;" type="text" class="form-control" name="senha" id="senha">
                                                                <br>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Nome</label>
                                                                <input style="font-size: 17px;" type="text" class="form-control" id="nome" name="nome">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>E-mail</label>
                                                                <input style="font-size: 17px;" type="text" class="form-control" id="email" name="email">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Endereço</label>
                                                                <input style="font-size: 17px;" type="text" class="form-control" id="end" name="end">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Telefone</label>
                                                                <input style="font-size: 17px;" type="text" class="form-control" id="tel" name="tel">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>CPF</label>
                                                                <input style="font-size: 17px;" type="text" class="form-control" id="cpf" name="cpf">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Data do Cadastro</label>
                                                                <input style="font-size: 17px;" type="text" disabled class="form-control" id="dt" name="dt" value="<% out.print(hoje); %>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
