                            ...
                            <div class="col-md-4 d-flex align-items-stretch grid-margin">
                                <div class="row flex-grow">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h6 style="text-align: center; color: #fff5cc; background-color: #ffaf00; padding: 3px; border-radius: 3px; position: relative;">Expira em: 12/05/2019</h6>
                                                <button type="button" style="margin: auto; display: flex;" class="btn btn-inverse-primary btn-fw">Renovar Livro</button>                                                
                            ...
                            <div class="col-md-4 d-flex align-items-stretch grid-margin">
                                <div class="row flex-grow">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h6 style="text-align: center; color: #fff5cc; background-color: #ffaf00; padding: 3px; border-radius: 3px; position: relative;">Expira em: 19/05/2019</h6>
                                                <button type="button" style="margin: auto; display: flex;" class="btn btn-inverse-primary btn-fw">Renovar Livro</button>                                                
                                                <img src="img/livros/2.png" style="padding-top: 8px; margin: auto; display: flex;"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 d-flex align-items-stretch grid-margin">
                                <div class="row flex-grow">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h6 style="text-align: center; color: #fff5cc; background-color: #ffaf00; padding: 3px; border-radius: 3px; position: relative;">Expira em: 23/05/2019</h6>
                                                <button type="button" style="margin: auto; display: flex;" class="btn btn-inverse-primary btn-fw">Renovar Livro</button>                                                
                                                <img src="img/livros/3.png" style="padding-top: 8px; margin: auto; display: flex;"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
