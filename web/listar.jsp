<%-- 
    Document   : listar
    Created on : 06/05/2019, 16:30:32
    Author     : João Otavio
--%>
        ...
        <div class="container-scroller">
            ...
            <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
                    <a class="navbar-brand brand-logo" href="system.jsp">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><label class="badge badge-info">Memórias Póstumas de Brás Cubas</label></td>
                                                        <td>05/04/2019</td>
                                                        <td>19/04/2019</td>
                                                        <td><label class="badge badge-danger">1817833</label></td>
                                                        <td><label class="badge badge-warning">joaokorcz@hotmail.com</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="badge badge-info">Conexão com a Matemática</label></td>
                                                        <td>10/04/2019</td>
                                                        <td>24/04/2019</td>
                                                        <td><label class="badge badge-danger">1817833</label></td>
                                                        <td><label class="badge badge-warning">joaokorcz@hotmail.com</label></td>
                                                    ...
                                                    <tr>
                                                        <td><label class="badge badge-info">Química</label></td>
                                                        <td>10/04/2019</td>
                                                        <td>24/04/2019</td>
                                                        <td><label class="badge badge-danger">1823313</label></td>
                                                        <td><label class="badge badge-warning">spdsadpa@gmail.com</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="badge badge-info">Física</label></td>
                                                        <td>10/04/2019</td>
                                                        <td>24/04/2019</td>
                                                        <td><label class="badge badge-danger">1817222</label></td>
                                                        <td><label class="badge badge-warning">dnsajnda@yahoo.com</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="badge badge-info">História Moderna</label></td>
                                                        <td>14/04/2019</td>
                                                        <td>28/04/2019</td>
                                                        <td><label class="badge badge-danger">1812121</label></td>
                                                        <td><label class="badge badge-warning">djasdsa@gmail.com</label></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
